    ...
    def create_revenue_tab(self):
        ...
        for i, (label, value, trend) in enumerate(kpis):
            ttk.Label(kpi_frame, text=label).grid(
                row=i // 2, column=(i % 2) * 3, sticky="w", padx=5, pady=5
            )
            ttk.Label(kpi_frame, text=value, font=("Arial", 12, "bold")).grid(
                row=i // 2, column=(i % 2) * 3 + 1, padx=5, pady=5
            )
            ttk.Label(kpi_frame, text=trend).grid(
                row=i // 2, column=(i % 2) * 3 + 2, padx=5, pady=5
            )
